...
Prosjektet benytter registerdata uten direkte personopplysninger, og operatør-ID er strukturelt fraværende i BRIS-eksporter. DSB (BRIS Support) vurderte datagrunnlaget på forespørsel (e-post april 2026): BRIS-fullrapporten kan deles som del av peer review uten databehandleravtale, ettersom formålet ikke er å behandle personopplysninger; MOB-rapportene er ikke unntatt offentlighet; og aggregerte analyseresultater kan publiseres, da tilsvarende statistikk i hovedsak er åpent tilgjengelig på brannstatistikk.no. Ved å utelate kommune og andre geografiske indikatorer er ytterligere anonymisering ikke nødvendig. Rapporten presenterer kun aggregerte størrelser (prosentfordelinger, medianer, fordelingstabeller), og ingen enkeltoppdrag eller enkeltpersoner kan identifiseres. ROS- og beredskapsanalysene er ikke gjengitt i sin helhet: for 110 Sør-Vest er kun deler som ikke er unntatt offentlighet benyttet, etter en konkret vurdering mot unntaksbestemmelsene, mens 110 Vests tilsvarende analyser er offentlig tilgjengelige via Bergen kommune. Valideringssamtaler er gjennomført som operative fagsamtaler, ikke formelle forskningsintervjuer, og inneholder ikke personidentifiserbar informasjon. Studien er ikke vurdert å kreve godkjenning fra Sikt (tidligere NSD), da den ikke behandler personopplysninger. Rådata og interne prosedyre- og beredskapsdokumenter publiseres ikke.

Forfatterens operative tilknytning til 110 Sør-Vest er gjort eksplisitt og adressert metodisk gjennom refleksivitetsavsnittet i 5.1 og kontrollmekanismene i 5.6.2.

### 5.7.1 Bruk av kunstig intelligens

Generative KI-verktøy er brukt aktivt og i betydelig omfang i prosjektet, i tråd med føringene for emnet LOG650 «Logistikk og kunstig intelligens», der KI skal benyttes til tekstutforming. Store deler av rapportteksten og all analysekode er utkast-generert av Claude Code (Anthropic) på forfatterens detaljerte instruksjoner, og deretter gjennomgått, korrigert, omarbeidet, verifisert og godkjent av forfatteren. ChatGPT (OpenAI) er brukt til litteratursøk og metodiske innspill, og Codex (OpenAI) til uavhengig, skrivebeskyttet kryss-sjekk av at rapportens tall stemmer med kildedata.

Det faglige grunnlaget og alle beslutninger er forfatterens egne: problemstilling, forskningsspørsmål, operativ domenekunnskap, modellvalg, klassifiseringsregler og tolkning av funn. KI har formalisert, implementert og formulert; forfatteren har styrt, vurdert og avgjort, og står fullt faglig ansvarlig for innholdet. Modellresultatene er ikke KI-genererte: alle tall produseres av deterministiske Python-skript kjørt på registerdata med faste seed, og er reproduserbare uavhengig av KI. Alle figurer er produsert av Python-kode (matplotlib) skrevet med KI ut fra prosjektets egne data, ikke ved KI-bildegenerering; forfatteren har spesifisert utforming for hver figur og står ansvarlig for tolkning og presentasjon. Alle referanser er verifisert mot originalkildene, og KI er ikke ført opp som kilde. Fullstendig brukslogg og erklæring følger i Vedlegg D.
