...
Kapitlet svarer på forskningsspørsmålene slik: RQ1 behandles i avsnitt 7.1 og 7.2, RQ2 i 7.4, RQ3 i 7.5 til 7.7, RQ4 i 7.8 og RQ5 i 7.9 og 7.10. Avsnitt 7.11 samler hovedfunnene uten å innføre nye resultater.
...
Før resultatene presenteres er det viktig å være presis på *hva modellen kvantifiserer*. Erlang-C i Tabell 7.1 målte sannsynligheten for at et nytt anrop må stå i kø, altså en *ventetidsmetrikk*. Kapasitetsmodellen i 7.5 til 7.7 måler noe annet: sannsynligheten for at et nytt beredskapsanrop ankommer i en tilstand der den operative driftsstandarden (makkerpar) ikke kan opprettholdes. Det er en *prosedyrkonformitetsmetrikk*.
...
- **Brudd på driftsstandard** (ledige = 1): Solo-håndtering er operativt mulig, men uten makker, med redusert kvalitetssikring (jf. Antagelse A7 i Tabell 6.3 og diskusjonen i kap 8.2).
...
**Tabell 7.6: Kapasitetsnivå i variant A (beredskapsbelastning)**
...
For å besvare RQ4 er beredskapsanalysen for 110 Sør-Vest (Beredskapsanalyse 110 Vest, 2022) og tilhørende ROS-dokument (Risiko- og sårbarhetsanalyse 110 Vest) gjennomgått systematisk. Analysen er rent observerende, og vurderingen mot funnene fra primærmodellen drøftes i kap 8.3.4.
...
*Kap 7, Versjon 2.3 | Sist oppdatert: 2026-05-15 (nytt avsnitt 7.7.4 Bootstrap-CI for D-pri1-bindingstid + Tabell 7.10b)*