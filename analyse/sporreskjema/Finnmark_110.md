...
**Hvorfor jeg kontakter Finnmark 110:** for å kunne benchmarke kapasitetsbelastning må jeg
...
> Svarene behandles konfidensielt. Finnmark 110 navngis kun med eksplisitt samtykke.
...
|---|---|---|---|---|---|
| Ansatte heltid | 13 | 14 | 11 | 16 | +23.1% |
| Operatører dag — hverdag | 2 | 3 | 2 | 3 | |
| Operatører natt — hverdag | 2 | 2 | 2 | 3 | |
| Operatører dag — helg | 2 | 2 | 2 | 3 | |
| Operatører natt — helg | 2 | 2 | 2 | 3 | |
...
|---|---|---|---|---|---|
| Oppdrag — Brann | 249 | 278 | 245 | 245 | |
| Oppdrag — Ulykke | 372 | 322 | 400 | 346 | |
| **Sum med utrykning** | **621** | **600** | **645** | **591** | **+3.9%** |
| Unødige/falske utrykninger | 625 | 581 | 629 | 515 | |
...
| | 2022 | 2023 | 2024 | 2025 |
|---|---|---|---|---|
| Mottatte 110-anrop (MOB) | 2548 | 3034 | 3094 | 3141 |
...
**Spm 2.** Hvilken vaktordning kjører Finnmark 110?
...
**Spm 8.** Besvarer vaktleder (VL) normalt innkommende nødanrop ved Finnmark 110?
...
**Spm 9.** Hvordan beskriver dere prosedyrestandarden ved Finnmark 110?
...
**Spm 12.** Er kategoriseringen gjenkjennbar ved Finnmark 110? Mangler det en type, eller er noe slått sammen som burde vært skilt?
...
## Del 7 — Sentralspesifikke avklaringer for Finnmark 110 (DSB 2025-data)

> **Hvorfor dette avsnittet er spesifikt for Finnmark 110:** DSB har i 2026 levert et fullstendig hendelsesdatasett for alle 12 sentraler (2025). Jeg har klassifisert alle oppdrag etter V3-logikken (D-pri1 / D-aba / S / L-aba / L-hendelse / L-ukjent / F / V) basert på kolonnene «Oppdragstype», «Opprinnelig oppdragstype», «Kilde» og «Ressurs varslet». D er splittet i D-pri1 (pri-1-utrykning, krever makkerpar) og D-aba (ABA-utrykning med Kilde=Alarm, håndteres serielt). Sammenligningen avdekker at **Finnmark 110 avviker betydelig fra nasjonalt snitt på enkelte kategorier** — spørsmålene under er generert kun for dere, basert på hvor deres tall ligger i topp-3 (↑ HØY) eller bunn-3 (↓ LAV) av de 12 sentralene. **Vi kan ikke benchmarke dere mot andre sentraler uten å forstå om disse avvikene skyldes registreringspraksis, lokal organisering eller reell operativ forskjell.**

Under vises **Finnmark 110s tall i nasjonal sammenheng**. Avvikene er flagget med ↑ HØY eller ↓ LAV. For hver flagget kategori følger et spesifikt oppfølgingsspørsmål merket **[SENTRALSPESIFIKT AVVIK ved Finnmark 110]**.

### 7.1 Deres sentral i nasjonal sammenheng (DSB 2025)

Totalvolum DSB 2025: **7,402** oppdrag. MOB-selvrapport: **3,141** mottatte anrop. Forhold DSB/MOB: **2.4×**.

| Kategori | Deres andel | Antall | Nasj. median | Nasj. spenn | Avvik |
|---|---:|---:|---:|---:|---|
| D-pri1 — pri-1-utrykning (makkerpar) | 14.0% | 1,037 | 10.3% | 7.0–24.9% | ↑ HØY |
| D-aba — ABA-utrykning (serielt) | 3.3% | 244 | 4.6% | 0.0–14.1% | – |
| L-aba — ABA løst av 110 uten utrykning | 5.3% | 394 | 3.8% | 0.0–7.5% | – |
| L-hendelse — reell hendelse løst av 110 | 8.1% | 597 | 7.3% | 3.3–10.2% | – |
| L-ukjent — lukket uten opprinnelig type | 28.1% | 2,077 | 29.4% | 13.8–40.4% | – |
| F — feilringing | 8.6% | 640 | 13.9% | 8.6–20.6% | ↓ LAV |
| V — viderekobling | 1.2% | 87 | 1.2% | 0.6–2.6% | – |

### 7.2 Oppfølgingsspørsmål — sentralspesifikke avvik for Finnmark 110

**Spm 25.** **[SENTRALSPESIFIKT AVVIK ved Finnmark 110]** D-pri1-andel (pri-1-utrykninger som krever makkerpar) er høy (14.0%). Nasjonal median: 10.3%, spenn 7.0–24.9%. **Dere ligger blant de øverste 3 av 12 sentraler.**
...
**Spm 26.** **[SENTRALSPESIFIKT AVVIK ved Finnmark 110]** Feilring-andel er lav (8.6%). Nasjonal median: 13.9%, spenn 8.6–20.6%. **Dere ligger blant de nederste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 27.** **[SENTRALSPESIFIKT AVVIK ved Finnmark 110]** Alarmbehandlingstid avviker fra nasjonalt snitt. Median alarmbehandlingstid på D-oppdrag er **1.93 min** (nasj. median 1.25 min). p90 alarmbehandlingstid er **13.5 min** (nasj. median 6.1 min) — altså 10 % av D-oppdrag bruker mer enn dette før utalarmering. **Dere ligger blant de øverste 3 av 12 sentraler — krever lokal forklaring.**
...
**Spm 28.** Har det skjedd spesielle hendelser (storulykker, klimahendelser, nye oppgaver, organisasjonsendringer) i perioden 2022–2025 som har hatt vesentlig påvirkning på kapasitetssituasjonen?

> *Svar:*

**Spm 29.** Er det andre forhold ved kapasitetssituasjonen ved Finnmark 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
