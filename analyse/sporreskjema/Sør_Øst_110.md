...
**Hvorfor jeg kontakter Sør-Øst 110:** for å kunne benchmarke kapasitetsbelastning må jeg
...
> Svarene behandles konfidensielt. Sør-Øst 110 navngis kun med eksplisitt samtykke.
...
|---|---|---|---|---|---|
| Ansatte heltid | 32 | 32 | 32 | 37 | +15.6% |
| Operatører dag — hverdag | 5 | 5 | 5 | 6 | |
| Operatører natt — hverdag | 5 | 5 | 5 | 5 | |
| Operatører dag — helg | 5 | 5 | 5 | 5 | |
| Operatører natt — helg | 5 | 5 | 5 | 5 | |
...
|---|---|---|---|---|---|
| Oppdrag — Brann | 2317 | 2098 | 1935 | 2044 | |
| Oppdrag — Ulykke | 2534 | 2619 | 2408 | 2377 | |
| **Sum med utrykning** | **4851** | **4717** | **4343** | **4421** | **-10.5%** |
| Unødige/falske utrykninger | 8293 | 8685 | 8690 | 8210 | |
...
| | 2022 | 2023 | 2024 | 2025 |
|---|---|---|---|---|
| Mottatte 110-anrop (MOB) | 22517 | 26308 | 24956 | 27559 |
...
**Spm 2.** Hvilken vaktordning kjører Sør-Øst 110?
...
**Spm 8.** Besvarer vaktleder (VL) normalt innkommende nødanrop ved Sør-Øst 110?
...
**Spm 9.** Hvordan beskriver dere prosedyrestandarden ved Sør-Øst 110?
...
**Spm 12.** Er kategoriseringen gjenkjennbar ved Sør-Øst 110? Mangler det en type, eller er noe slått sammen som burde vært skilt?
...
## Del 7 — Sentralspesifikke avklaringer for Sør-Øst 110 (DSB 2025-data)

> **Hvorfor dette avsnittet er spesifikt for Sør-Øst 110:** DSB har i 2026 levert et fullstendig hendelsesdatasett for alle 12 sentraler (2025). Jeg har klassifisert alle oppdrag etter V3-logikken (D-pri1 / D-aba / S / L-aba / L-hendelse / L-ukjent / F / V) basert på kolonnene «Oppdragstype», «Opprinnelig oppdragstype», «Kilde» og «Ressurs varslet». D er splittet i D-pri1 (pri-1-utrykning, krever makkerpar) og D-aba (ABA-utrykning med Kilde=Alarm, håndteres serielt). Sammenligningen avdekker at **Sør-Øst 110 avviker betydelig fra nasjonalt snitt på enkelte kategorier** — spørsmålene under er generert kun for dere, basert på hvor deres tall ligger i topp-3 (↑ HØY) eller bunn-3 (↓ LAV) av de 12 sentralene. **Vi kan ikke benchmarke dere mot andre sentraler uten å forstå om disse avvikene skyldes registreringspraksis, lokal organisering eller reell operativ forskjell.**

Under vises **Sør-Øst 110s tall i nasjonal sammenheng**. Avvikene er flagget med ↑ HØY eller ↓ LAV. For hver flagget kategori følger et spesifikt oppfølgingsspørsmål merket **[SENTRALSPESIFIKT AVVIK ved Sør-Øst 110]**.

### 7.1 Deres sentral i nasjonal sammenheng (DSB 2025)

Totalvolum DSB 2025: **68,654** oppdrag. MOB-selvrapport: **27,559** mottatte anrop. Forhold DSB/MOB: **2.5×**.

| Kategori | Deres andel | Antall | Nasj. median | Nasj. spenn | Avvik |
|---|---:|---:|---:|---:|---|
| D-pri1 — pri-1-utrykning (makkerpar) | 20.6% | 14,174 | 10.3% | 7.0–24.9% | ↑ HØY |
| D-aba — ABA-utrykning (serielt) | 0.0% | 0 | 4.6% | 0.0–14.1% | ↓ LAV |
| L-aba — ABA løst av 110 uten utrykning | 0.0% | 0 | 3.8% | 0.0–7.5% | ↓ LAV |
| L-hendelse — reell hendelse løst av 110 | 10.2% | 7,028 | 7.3% | 3.3–10.2% | ↑ HØY |
| L-ukjent — lukket uten opprinnelig type | 28.7% | 19,730 | 29.4% | 13.8–40.4% | – |
| F — feilringing | 15.8% | 10,870 | 13.9% | 8.6–20.6% | – |
| V — viderekobling | 1.6% | 1,123 | 1.2% | 0.6–2.6% | ↑ HØY |

### 7.2 Oppfølgingsspørsmål — sentralspesifikke avvik for Sør-Øst 110

**Spm 25.** **[SENTRALSPESIFIKT AVVIK ved Sør-Øst 110]** ABA løst uten utrykning registrert som usedvanlig lav (0.0%, 0 oppdrag). Nasjonalt: median 3.8%, spenn 0.0–7.5%. Andre sentraler har rutinemessig 3–9 %. **Dette avviker betydelig fra forventet mønster og må forklares lokalt** — uten avklaring kan vi ikke benchmarke dere mot øvrige sentraler.

> *Avklaring:* Hvordan registreres automatiske brannalarmer som avklares uten utrykning (matlaging, damp, service utenom prosedyre) ved Sør-Øst 110? Velger dere en annen verdi for «Opprinnelig oppdragstype» enn 'ABA' ved slik avklaring, eller utløser ABA rutinemessig utrykning hos dere uavhengig av avklaring innen 90 sek? Kan dere beskrive registreringspraksis og ev. lokal prosedyre som skiller dere fra Sør-Vest-modellen?

> *Svar:*

**Spm 26.** **[SENTRALSPESIFIKT AVVIK ved Sør-Øst 110]** D-pri1-andel (pri-1-utrykninger som krever makkerpar) er høy (20.6%). Nasjonal median: 10.3%, spenn 7.0–24.9%. **Dere ligger blant de øverste 3 av 12 sentraler.**
...
**Spm 27.** **[SENTRALSPESIFIKT AVVIK ved Sør-Øst 110]** D-aba-andel (ABA-utrykninger registrert med Kilde=Alarm) er lav (0.0%). Nasjonal median: 4.6%, spenn 0.0–14.1%. **Dere ligger blant de nederste 3 av 12 sentraler.**
...
**Spm 28.** **[SENTRALSPESIFIKT AVVIK ved Sør-Øst 110]** L-hendelse-andel er høy (10.2%). Nasjonal median: 7.3%, spenn 3.3–10.2%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 29.** **[SENTRALSPESIFIKT AVVIK ved Sør-Øst 110]** Viderekoble-andel er høy (1.6%). Nasjonal median: 1.2%, spenn 0.6–2.6%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 31.** Er det andre forhold ved kapasitetssituasjonen ved Sør-Øst 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
