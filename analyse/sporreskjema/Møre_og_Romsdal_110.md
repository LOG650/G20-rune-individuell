...
|---|---:|---:|---:|---:|---|
| D — utrykning | 11.9% | 3,492 | 18.4% | 9.3–24.9% | ↓ LAV |
| L-aba — ABA løst av 110 | 4.2% | 1,230 | 4.9% | 0.0–8.9% | – |
| L-hendelse — reell hendelse løst av 110 | 2.9% | 838 | 5.3% | 2.9–10.2% | ↓ LAV |
...
**Spm 24.** **Utrykningsrate (D-andel) er lav (11.9%).** Nasjonal median: 18.4%. Andelen oppdrag som fører til utrykning er lavere enn for andre sentraler.
...
**Spm 25.** **L-hendelse-andel er lav (2.9%).** Nasjonal median: 5.3%. Få reelle hendelser registreres som avklart uten utrykning hos dere.
...
**Spm 26.** **L-ukjent-andel er lav (18.8%).** Nasjonal median: 29.4%. Dere setter altså «Opprinnelig oppdragstype» oftere enn andre ved lukking.
...
**Spm 27.** **Forhold DSB/MOB er høyt (3.6×).** Nasjonal median: 2.5×. MOB-selvrapport: 8,096 mottatte anrop. DSB: 29,384 oppdrag.
...
**Spm 28.** **Alarmbehandlingstid avviker fra nasjonalt snitt.** Median alarmbehandlingstid på D-oppdrag er **2.01 min** (nasj. median 1.25 min). p90 alarmbehandlingstid er **9.5 min** (nasj. median 6.1 min) — altså 10 % av D-oppdrag bruker mer enn dette før utalarmering.
...
**Spm 30.** Er det andre forhold ved kapasitetssituasjonen ved Møre og Romsdal 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
