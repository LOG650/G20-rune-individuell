...
**Hvorfor jeg kontakter Oslo 110:** for å kunne benchmarke kapasitetsbelastning må jeg
...
> Svarene behandles konfidensielt. Oslo 110 navngis kun med eksplisitt samtykke.
...
| Operatører dag — hverdag | 5 | 5 | 5 | 5 | |
...
| Unødige/falske utrykninger | 13135 | 13468 | 13621 | 11537 | |
...
**Spm 2.** Hvilken vaktordning kjører Oslo 110?
...
**Spm 8.** Besvarer vaktleder (VL) normalt innkommende nødanrop ved Oslo 110?
...
**Spm 9.** Hvordan beskriver dere prosedyrestandarden ved Oslo 110?
...
**Spm 12.** Er kategoriseringen gjenkjennbar ved Oslo 110? Mangler det en type, eller er noe slått sammen som burde vært skilt?
...
## Del 7 — Sentralspesifikke avklaringer for Oslo 110 (DSB 2025-data)

> **Hvorfor dette avsnittet er spesifikt for Oslo 110:** DSB har i 2026 levert et fullstendig hendelsesdatasett for alle 12 sentraler (2025). Jeg har klassifisert alle oppdrag etter V3-logikken (D-pri1 / D-aba / S / L-aba / L-hendelse / L-ukjent / F / V) basert på kolonnene «Oppdragstype», «Opprinnelig oppdragstype», «Kilde» og «Ressurs varslet». D er splittet i D-pri1 (pri-1-utrykning, krever makkerpar) og D-aba (ABA-utrykning med Kilde=Alarm, håndteres serielt). Sammenligningen avdekker at **Oslo 110 avviker betydelig fra nasjonalt snitt på enkelte kategorier** — spørsmålene under er generert kun for dere, basert på hvor deres tall ligger i topp-3 (↑ HØY) eller bunn-3 (↓ LAV) av de 12 sentralene. **Vi kan ikke benchmarke dere mot andre sentraler uten å forstå om disse avvikene skyldes registreringspraksis, lokal organisering eller reell operativ forskjell.**

Under vises **Oslo 110s tall i nasjonal sammenheng**. Avvikene er flagget med ↑ HØY eller ↓ LAV. For hver flagget kategori følger et spesifikt oppfølgingsspørsmål merket **[SENTRALSPESIFIKT AVVIK ved Oslo 110]**.

### 7.1 Deres sentral i nasjonal sammenheng (DSB 2025)

Totalvolum DSB 2025: **71,421** oppdrag. MOB-selvrapport: **30,000** mottatte anrop. Forhold DSB/MOB: **2.4×**.

| Kategori | Deres andel | Antall | Nasj. median | Nasj. spenn | Avvik |
|---|---:|---:|---:|---:|---|
| D-pri1 — pri-1-utrykning (makkerpar) | 24.9% | 17,804 | 10.3% | 7.0–24.9% | ↑ HØY |
| D-aba — ABA-utrykning (serielt) | 0.0% | 7 | 4.6% | 0.0–14.1% | ↓ LAV |
| L-aba — ABA løst av 110 uten utrykning | 0.0% | 3 | 3.8% | 0.0–7.5% | ↓ LAV |
| L-hendelse — reell hendelse løst av 110 | 9.3% | 6,638 | 7.3% | 3.3–10.2% | ↑ HØY |
| L-ukjent — lukket uten opprinnelig type | 40.4% | 28,828 | 29.4% | 13.8–40.4% | ↑ HØY |
| F — feilringing | 14.5% | 10,386 | 13.9% | 8.6–20.6% | – |
| V — viderekobling | 1.5% | 1,089 | 1.2% | 0.6–2.6% | – |

### 7.2 Oppfølgingsspørsmål — sentralspesifikke avvik for Oslo 110

**Spm 25.** **[SENTRALSPESIFIKT AVVIK ved Oslo 110]** ABA løst uten utrykning registrert som usedvanlig lav (0.0%, 3 oppdrag). Nasjonalt: median 3.8%, spenn 0.0–7.5%. Andre sentraler har rutinemessig 3–9 %. **Dette avviker betydelig fra forventet mønster og må forklares lokalt** — uten avklaring kan vi ikke benchmarke dere mot øvrige sentraler.

> *Avklaring:* Hvordan registreres automatiske brannalarmer som avklares uten utrykning (matlaging, damp, service utenom prosedyre) ved Oslo 110? Velger dere en annen verdi for «Opprinnelig oppdragstype» enn 'ABA' ved slik avklaring, eller utløser ABA rutinemessig utrykning hos dere uavhengig av avklaring innen 90 sek? Kan dere beskrive registreringspraksis og ev. lokal prosedyre som skiller dere fra Sør-Vest-modellen?

> *Svar:*

**Spm 26.** **[SENTRALSPESIFIKT AVVIK ved Oslo 110]** Utrykningsrate (D-andel) er høy (24.9%). Nasjonal median: 18.4%, spenn 9.3–24.9%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**

> *Avklaring:* Registreres færre oppdrag som «avklart uten utrykning» hos dere, eller har dere praksis der utrykning aktiveres raskere (f.eks. på ABA uten ventetid, eller ved lav terskel for bekreftelse)?

> *Svar:*

**Spm 27.** **[SENTRALSPESIFIKT AVVIK ved Oslo 110]** D-pri1-andel (pri-1-utrykninger som krever makkerpar) er høy (24.9%). Nasjonal median: 10.3%, spenn 7.0–24.9%. **Dere ligger blant de øverste 3 av 12 sentraler.**
...
**Spm 28.** **[SENTRALSPESIFIKT AVVIK ved Oslo 110]** D-aba-andel (ABA-utrykninger registrert med Kilde=Alarm) er lav (0.0%). Nasjonal median: 4.6%, spenn 0.0–14.1%. **Dere ligger blant de nederste 3 av 12 sentraler.**
...
**Spm 29.** **[SENTRALSPESIFIKT AVVIK ved Oslo 110]** L-hendelse-andel er høy (9.3%). Nasjonal median: 7.3%, spenn 3.3–10.2%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 30.** **[SENTRALSPESIFIKT AVVIK ved Oslo 110]** L-ukjent-andel er høy (40.4%). Nasjonal median: 29.4%, spenn 13.8–40.4%. **Dere ligger blant de øverste 3 av 12 sentraler — store mengder oppdrag er registrert som «Oppdrag løst av 110» uten at «Opprinnelig oppdragstype» er satt. Dette må forklares lokalt før vi kan tolke L-ukjent som sammenlignbar kategori.**
...
**Spm 31.** Har det skjedd spesielle hendelser (storulykker, klimahendelser, nye oppgaver, organisasjonsendringer) i perioden 2022–2025 som har hatt vesentlig påvirkning på kapasitetssituasjonen?

> *Svar:*

**Spm 32.** Er det andre forhold ved kapasitetssituasjonen ved Oslo 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
