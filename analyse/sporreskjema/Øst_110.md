...
**Hvorfor jeg kontakter Øst 110:** for å kunne benchmarke kapasitetsbelastning må jeg
...
> Svarene behandles konfidensielt. Øst 110 navngis kun med eksplisitt samtykke.
...
|---|---|---|---|---|---|
| Ansatte heltid | 39 | 39 | 39 | 39 | +0.0% |
| Operatører dag — hverdag | 6 | 6 | 6 | 6 | |
| Operatører natt — hverdag | 6 | 6 | 6 | 6 | |
| Operatører dag — helg | 6 | 6 | 6 | 6 | |
| Operatører natt — helg | 6 | 6 | 6 | 6 | |
...
|---|---|---|---|---|---|
| Oppdrag — Brann | 2112 | 2198 | 1797 | 1778 | |
| Oppdrag — Ulykke | 2528 | 2674 | 2312 | 2370 | |
| **Sum med utrykning** | **4640** | **4872** | **4109** | **4148** | **-11.4%** |
| Unødige/falske utrykninger | 7144 | 7114 | 7471 | 6853 | |
...
| | 2022 | 2023 | 2024 | 2025 |
|---|---|---|---|---|
| Mottatte 110-anrop (MOB) | 16374 | 22304 | 19880 | 25962 |
...
**Spm 2.** Hvilken vaktordning kjører Øst 110?
...
**Spm 8.** Besvarer vaktleder (VL) normalt innkommende nødanrop ved Øst 110?
...
**Spm 9.** Hvordan beskriver dere prosedyrestandarden ved Øst 110?
...
**Spm 12.** Er kategoriseringen gjenkjennbar ved Øst 110? Mangler det en type, eller er noe slått sammen som burde vært skilt?
...
- ROS-analyse sist revidert: **2021**
...
## Del 7 — Sentralspesifikke avklaringer for Øst 110 (DSB 2025-data)

> **Hvorfor dette avsnittet er spesifikt for Øst 110:** DSB har i 2026 levert et fullstendig hendelsesdatasett for alle 12 sentraler (2025). Jeg har klassifisert alle oppdrag etter V3-logikken (D-pri1 / D-aba / S / L-aba / L-hendelse / L-ukjent / F / V) basert på kolonnene «Oppdragstype», «Opprinnelig oppdragstype», «Kilde» og «Ressurs varslet». D er splittet i D-pri1 (pri-1-utrykning, krever makkerpar) og D-aba (ABA-utrykning med Kilde=Alarm, håndteres serielt). Sammenligningen avdekker at **Øst 110 avviker betydelig fra nasjonalt snitt på enkelte kategorier** — spørsmålene under er generert kun for dere, basert på hvor deres tall ligger i topp-3 (↑ HØY) eller bunn-3 (↓ LAV) av de 12 sentralene. **Vi kan ikke benchmarke dere mot andre sentraler uten å forstå om disse avvikene skyldes registreringspraksis, lokal organisering eller reell operativ forskjell.**

Under vises **Øst 110s tall i nasjonal sammenheng**. Avvikene er flagget med ↑ HØY eller ↓ LAV. For hver flagget kategori følger et spesifikt oppfølgingsspørsmål merket **[SENTRALSPESIFIKT AVVIK ved Øst 110]**.

### 7.1 Deres sentral i nasjonal sammenheng (DSB 2025)

Totalvolum DSB 2025: **58,138** oppdrag. MOB-selvrapport: **25,962** mottatte anrop. Forhold DSB/MOB: **2.2×**.

| Kategori | Deres andel | Antall | Nasj. median | Nasj. spenn | Avvik |
|---|---:|---:|---:|---:|---|
| D-pri1 — pri-1-utrykning (makkerpar) | 11.8% | 6,870 | 10.3% | 7.0–24.9% | – |
| D-aba — ABA-utrykning (serielt) | 9.6% | 5,608 | 4.6% | 0.0–14.1% | – |
| L-aba — ABA løst av 110 uten utrykning | 2.3% | 1,337 | 3.8% | 0.0–7.5% | – |
| L-hendelse — reell hendelse løst av 110 | 5.8% | 3,359 | 7.3% | 3.3–10.2% | – |
| L-ukjent — lukket uten opprinnelig type | 34.8% | 20,249 | 29.4% | 13.8–40.4% | – |
| F — feilringing | 20.6% | 11,951 | 13.9% | 8.6–20.6% | ↑ HØY |
| V — viderekobling | 1.5% | 894 | 1.2% | 0.6–2.6% | – |

### 7.2 Oppfølgingsspørsmål — sentralspesifikke avvik for Øst 110

**Spm 25.** **[SENTRALSPESIFIKT AVVIK ved Øst 110]** Utrykningsrate (D-andel) er høy (21.5%). Nasjonal median: 18.4%, spenn 9.3–24.9%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 26.** **[SENTRALSPESIFIKT AVVIK ved Øst 110]** Feilring-andel er høy (20.6%). Nasjonal median: 13.9%, spenn 8.6–20.6%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 27.** **[SENTRALSPESIFIKT AVVIK ved Øst 110]** Forhold DSB/MOB er lavt (2.2×). Nasjonal median: 2.5×. MOB-selvrapport: 25,962 mottatte anrop. DSB-oppdrag: 58,138. **Dere ligger blant de nederste 3 av 12 sentraler i differanse — krever forklaring for at MOB- og DSB-tall skal kunne brukes konsistent.**
...
**Spm 29.** Er det andre forhold ved kapasitetssituasjonen ved Øst 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
