...
**Hvorfor jeg kontakter Nordland 110:** for å kunne benchmarke kapasitetsbelastning må jeg
...
> Svarene behandles konfidensielt. Nordland 110 navngis kun med eksplisitt samtykke.
...
|---|---|---|---|---|---|
| Ansatte heltid | 21 | 21 | 21 | 21 | +0.0% |
| Operatører dag — hverdag | 3 | 3 | 3 | 3 | |
...
|---|---|---|---|---|---|
| Oppdrag — Brann | 526 | 491 | 557 | 458 | |
| Oppdrag — Ulykke | 818 | 876 | 961 | 897 | |
| **Sum med utrykning** | **1344** | **1367** | **1518** | **1355** | **+12.9%** |
| Unødige/falske utrykninger | 1407 | 1250 | 1177 | 1067 | |
...
| | 2022 | 2023 | 2024 | 2025 |
|---|---|---|---|---|
| Mottatte 110-anrop (MOB) | 8270 | 8117 | 8846 | 8781 |
...
**Spm 2.** Hvilken vaktordning kjører Nordland 110?
...
**Spm 8.** Besvarer vaktleder (VL) normalt innkommende nødanrop ved Nordland 110?
...
**Spm 9.** Hvordan beskriver dere prosedyrestandarden ved Nordland 110?
...
**Spm 12.** Er kategoriseringen gjenkjennbar ved Nordland 110? Mangler det en type, eller er noe slått sammen som burde vært skilt?
...
- Beredskapsanalyse utarbeidet: **Nei**, sist revidert: **—**
...
## Del 7 — Sentralspesifikke avklaringer for Nordland 110 (DSB 2025-data)

> **Hvorfor dette avsnittet er spesifikt for Nordland 110:** DSB har i 2026 levert et fullstendig hendelsesdatasett for alle 12 sentraler (2025). Jeg har klassifisert alle oppdrag etter V3-logikken (D-pri1 / D-aba / S / L-aba / L-hendelse / L-ukjent / F / V) basert på kolonnene «Oppdragstype», «Opprinnelig oppdragstype», «Kilde» og «Ressurs varslet». D er splittet i D-pri1 (pri-1-utrykning, krever makkerpar) og D-aba (ABA-utrykning med Kilde=Alarm, håndteres serielt). Sammenligningen avdekker at **Nordland 110 avviker betydelig fra nasjonalt snitt på enkelte kategorier** — spørsmålene under er generert kun for dere, basert på hvor deres tall ligger i topp-3 (↑ HØY) eller bunn-3 (↓ LAV) av de 12 sentralene. **Vi kan ikke benchmarke dere mot andre sentraler uten å forstå om disse avvikene skyldes registreringspraksis, lokal organisering eller reell operativ forskjell.**

Under vises **Nordland 110s tall i nasjonal sammenheng**. Avvikene er flagget med ↑ HØY eller ↓ LAV. For hver flagget kategori følger et spesifikt oppfølgingsspørsmål merket **[SENTRALSPESIFIKT AVVIK ved Nordland 110]**.

### 7.1 Deres sentral i nasjonal sammenheng (DSB 2025)

Totalvolum DSB 2025: **29,577** oppdrag. MOB-selvrapport: **8,781** mottatte anrop. Forhold DSB/MOB: **3.4×**.

| Kategori | Deres andel | Antall | Nasj. median | Nasj. spenn | Avvik |
|---|---:|---:|---:|---:|---|
| D-pri1 — pri-1-utrykning (makkerpar) | 7.0% | 2,069 | 10.3% | 7.0–24.9% | ↓ LAV |
| D-aba — ABA-utrykning (serielt) | 2.3% | 680 | 4.6% | 0.0–14.1% | – |
| L-aba — ABA løst av 110 uten utrykning | 7.5% | 2,224 | 3.8% | 0.0–7.5% | ↑ HØY |
| L-hendelse — reell hendelse løst av 110 | 4.5% | 1,318 | 7.3% | 3.3–10.2% | – |
| L-ukjent — lukket uten opprinnelig type | 30.1% | 8,893 | 29.4% | 13.8–40.4% | – |
| F — feilringing | 9.1% | 2,694 | 13.9% | 8.6–20.6% | ↓ LAV |
| V — viderekobling | 1.5% | 457 | 1.2% | 0.6–2.6% | ↑ HØY |

### 7.2 Oppfølgingsspørsmål — sentralspesifikke avvik for Nordland 110

**Spm 25.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** ABA løst uten utrykning er høy (7.5%, 2224 oppdrag). Nasjonalt: median 3.8%, spenn 0.0–7.5%. **Dette avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 26.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** Utrykningsrate (D-andel) er lav (9.3%). Nasjonal median: 18.4%, spenn 9.3–24.9%. **Dere ligger blant de nederste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 27.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** D-pri1-andel (pri-1-utrykninger som krever makkerpar) er lav (7.0%). Nasjonal median: 10.3%, spenn 7.0–24.9%. **Dere ligger blant de nederste 3 av 12 sentraler.**
...
**Spm 28.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** Feilring-andel er lav (9.1%). Nasjonal median: 13.9%, spenn 8.6–20.6%. **Dere ligger blant de nederste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**

> *Avklaring:* Registreres feilringinger under annen kategori (f.eks. L-ukjent eller V), eller er feilringinger faktisk sjeldnere i deres distrikt?

> *Svar:*

**Spm 29.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** Viderekoble-andel er høy (1.5%). Nasjonal median: 1.2%, spenn 0.6–2.6%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 30.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** Forhold DSB/MOB er høyt (3.4×). Nasjonal median: 2.5×. MOB-selvrapport: 8,781 mottatte anrop. DSB-oppdrag: 29,577. **Dere ligger blant de øverste 3 av 12 sentraler i differanse — krever forklaring for at MOB- og DSB-tall skal kunne brukes konsistent.**
...
**Spm 31.** **[SENTRALSPESIFIKT AVVIK ved Nordland 110]** Alarmbehandlingstid avviker fra nasjonalt snitt. Median alarmbehandlingstid på D-oppdrag er **2.43 min** (nasj. median 1.25 min). p90 alarmbehandlingstid er **34.0 min** (nasj. median 6.1 min) — altså 10 % av D-oppdrag bruker mer enn dette før utalarmering. **Dere ligger blant de øverste 3 av 12 sentraler — krever lokal forklaring.**

> *Avklaring:* Kan forskjellen forklares av geografiske forhold (lengre verifikasjon/kjentmenn), volum per operatør, eller registreringspraksis (f.eks. hvordan tidspunkt for «ressurs varslet» settes)?
...
**Spm 32.** Har det skjedd spesielle hendelser (storulykker, klimahendelser, nye oppgaver, organisasjonsendringer) i perioden 2022–2025 som har hatt vesentlig påvirkning på kapasitetssituasjonen?

> *Svar:*

**Spm 33.** Er det andre forhold ved kapasitetssituasjonen ved Nordland 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
