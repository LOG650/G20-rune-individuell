...
**Hvorfor jeg kontakter Agder 110:** for å kunne benchmarke kapasitetsbelastning må jeg
...
> Svarene behandles konfidensielt. Agder 110 navngis kun med eksplisitt samtykke.
...
|---|---|---|---|---|---|
| Ansatte heltid | 18 | 18 | 18 | 20 | +11.1% |
| Operatører dag — hverdag | 4 | 4 | 3 | 4 | |
...
|---|---|---|---|---|---|
| Oppdrag — Brann | 1123 | 1076 | 938 | 1012 | |
| Oppdrag — Ulykke | 663 | 668 | 676 | 736 | |
| **Sum med utrykning** | **1786** | **1744** | **1614** | **1748** | **-9.6%** |
| Unødige/falske utrykninger | 4232 | 4348 | 4586 | 4190 | |
...
| | 2022 | 2023 | 2024 | 2025 |
|---|---|---|---|---|
| Mottatte 110-anrop (MOB) | 8903 | 10858 | 10969 | 12417 |
...
**Spm 2.** Hvilken vaktordning kjører Agder 110?
...
**Spm 8.** Besvarer vaktleder (VL) normalt innkommende nødanrop ved Agder 110?
...
**Spm 9.** Hvordan beskriver dere prosedyrestandarden ved Agder 110?
...
**Spm 12.** Er kategoriseringen gjenkjennbar ved Agder 110? Mangler det en type, eller er noe slått sammen som burde vært skilt?
...
- ROS-analyse sist revidert: **2024**
- Beredskapsanalyse utarbeidet: **Ja**, sist revidert: **2024**
...
## Del 7 — Sentralspesifikke avklaringer for Agder 110 (DSB 2025-data)

> **Hvorfor dette avsnittet er spesifikt for Agder 110:** DSB har i 2026 levert et fullstendig hendelsesdatasett for alle 12 sentraler (2025). Jeg har klassifisert alle oppdrag etter V3-logikken (D-pri1 / D-aba / S / L-aba / L-hendelse / L-ukjent / F / V) basert på kolonnene «Oppdragstype», «Opprinnelig oppdragstype», «Kilde» og «Ressurs varslet». D er splittet i D-pri1 (pri-1-utrykning, krever makkerpar) og D-aba (ABA-utrykning med Kilde=Alarm, håndteres serielt). Sammenligningen avdekker at **Agder 110 avviker betydelig fra nasjonalt snitt på enkelte kategorier** — spørsmålene under er generert kun for dere, basert på hvor deres tall ligger i topp-3 (↑ HØY) eller bunn-3 (↓ LAV) av de 12 sentralene. **Vi kan ikke benchmarke dere mot andre sentraler uten å forstå om disse avvikene skyldes registreringspraksis, lokal organisering eller reell operativ forskjell.**

Under vises **Agder 110s tall i nasjonal sammenheng**. Avvikene er flagget med ↑ HØY eller ↓ LAV. For hver flagget kategori følger et spesifikt oppfølgingsspørsmål merket **[SENTRALSPESIFIKT AVVIK ved Agder 110]**.

### 7.1 Deres sentral i nasjonal sammenheng (DSB 2025)

Totalvolum DSB 2025: **26,238** oppdrag. MOB-selvrapport: **12,417** mottatte anrop. Forhold DSB/MOB: **2.1×**.

| Kategori | Deres andel | Antall | Nasj. median | Nasj. spenn | Avvik |
|---|---:|---:|---:|---:|---|
| D-pri1 — pri-1-utrykning (makkerpar) | 10.3% | 2,710 | 10.3% | 7.0–24.9% | – |
| D-aba — ABA-utrykning (serielt) | 14.1% | 3,699 | 4.6% | 0.0–14.1% | ↑ HØY |
| L-aba — ABA løst av 110 uten utrykning | 3.8% | 1,001 | 3.8% | 0.0–7.5% | – |
| L-hendelse — reell hendelse løst av 110 | 7.6% | 1,991 | 7.3% | 3.3–10.2% | – |
| L-ukjent — lukket uten opprinnelig type | 13.8% | 3,608 | 29.4% | 13.8–40.4% | ↓ LAV |
| F — feilringing | 18.5% | 4,856 | 13.9% | 8.6–20.6% | ↑ HØY |
| V — viderekobling | 1.0% | 263 | 1.2% | 0.6–2.6% | – |

### 7.2 Oppfølgingsspørsmål — sentralspesifikke avvik for Agder 110

**Spm 25.** **[SENTRALSPESIFIKT AVVIK ved Agder 110]** Utrykningsrate (D-andel) er høy (24.4%). Nasjonal median: 18.4%, spenn 9.3–24.9%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 26.** **[SENTRALSPESIFIKT AVVIK ved Agder 110]** D-aba-andel (ABA-utrykninger registrert med Kilde=Alarm) er høy (14.1%). Nasjonal median: 4.6%, spenn 0.0–14.1%. **Dere ligger blant de øverste 3 av 12 sentraler.**
...
**Spm 27.** **[SENTRALSPESIFIKT AVVIK ved Agder 110]** L-ukjent-andel er lav (13.8%). Nasjonal median: 29.4%, spenn 13.8–40.4%. **Dere setter «Opprinnelig oppdragstype» oftere enn andre sentraler ved lukking — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 28.** **[SENTRALSPESIFIKT AVVIK ved Agder 110]** Feilring-andel er høy (18.5%). Nasjonal median: 13.9%, spenn 8.6–20.6%. **Dere ligger blant de øverste 3 av 12 sentraler — avviker fra forventet mønster og må forklares lokalt.**
...
**Spm 29.** **[SENTRALSPESIFIKT AVVIK ved Agder 110]** Forhold DSB/MOB er lavt (2.1×). Nasjonal median: 2.5×. MOB-selvrapport: 12,417 mottatte anrop. DSB-oppdrag: 26,238. **Dere ligger blant de nederste 3 av 12 sentraler i differanse — krever forklaring for at MOB- og DSB-tall skal kunne brukes konsistent.**
...
**Spm 31.** Er det andre forhold ved kapasitetssituasjonen ved Agder 110 som er viktig å forstå, og som ikke dekkes av spørsmålene ovenfor?
